...
$.getJSON('itemTypes.json', function(json) {
    itemTypes = json; 

    for(var i in itemTypes){
    	var img = new Image();
    	img.src = itemTypes[i].src;
    	itemTypes[i].img = img;
    }
});
...
var world = {
  ...
  init: function(){
    ...
    world.addBlock(new Block(itemTypes.ground_large, 0,12));
    world.addBlock(new Block(itemTypes.ground_large, -40,12));
    world.addBlock(new Block(itemTypes.ground_large, 40,12));

    world.addBlock(new Block(itemTypes.house, 10,-5));
